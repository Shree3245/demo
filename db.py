...
def itemInsert2(productName, chineseName, SKU, colour, weight, height,width,length, description, material, quantity_inStock, cost_AUD, cost_RMB, cost_USD, category, status, quantity_sold):
    itemEntry = productInfo(
...
def newPhysItemCreate(sku,itemname,minStat):
